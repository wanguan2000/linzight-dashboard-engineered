...
const exactEnglish: Record<string, string> = {
  ...
  '样本查看': 'View samples',
  '选择患者': 'Select patient',
  '选择患者后新增样本': 'Select a patient to add sample',
  '选择患者后新增检测': 'Select a patient to add test',
  '选择样本后新增检测': 'Select samples to add test',
  '支持按患者编号、姓名、住院号或 Study 搜索': 'Search by patient ID, name, hospital number, or Study',
  '先确定患者，再选择该患者名下样本': 'Choose a patient first, then select samples under that patient',
  '搜索患者编号、姓名、住院号或 Study': 'Search patient ID, name, hospital number, or Study',
  '已有样本数': 'Existing samples',
  '未找到匹配患者': 'No matching patient found',
  '名患者': 'patients',
  '已选择患者': 'Selected patient',
  '更换患者': 'Change patient',
  '请选择该患者本次检测使用的样本': 'Select samples used for this test',
  '请先选择患者后新增样本': 'Select a patient before adding a sample',
  '请先选择患者后新增检测': 'Select a patient before adding a test',
  '当前角色没有样本写入权限': 'Current role does not have sample write permission',
  '当前角色没有检测写入权限': 'Current role does not have test write permission',
  '该患者暂无样本，请先新增样本': 'This patient has no samples. Add a sample first.',
  '去新增样本': 'Add sample',
  '已选择': 'Selected',
  '个样本': 'samples',
  '下一步填写检测': 'Next: fill test details',
  '本次检测样本': 'Samples for this test',
  'Study 系统管理': 'Study System Management',
  'Study 名称': 'Study name',
  'CRF完整性': 'CRF completeness',
  'CRF完整性优先': 'CRF completeness first',
  ...
  'LZ 全局首页工作台': 'LZ Global Workbench',
  '汇总所有授权 Study 的患者、样本、检测、访视、CRF 和导出统计。':
    'Aggregate patient, sample, testing, visit, CRF, and export metrics across all authorized Studies.',
  '搜索全局运营指标、患者、样本或检测状态...': 'Search global operations metrics, patients, samples, or testing status...',
  '全局患者': 'Global patients',
  '汇总所有授权 Study 的患者队列；业务读写仍逐个使用 Study Workspace API。':
    'Aggregate patient cohorts across all authorized Studies; write operations still use each Study Workspace API.',
  '样本与检测': 'Samples & testing',
  '汇总所有授权 Study 的样本、检测和组学记录。': 'Aggregate sample, testing, and omics records across all authorized Studies.',
  '搜索全局样本编号、检测项目、Study 或状态...': 'Search global sample ID, test item, Study, or status...',
  'LZ 全局视角': 'LZ global view',
  '全部或授权 Study': 'All or assigned Studies',
  '统计范围': 'Statistics scope',
  '所有可访问 Study': 'All accessible Studies',
  ...
  '填写 Study 信息': 'Fill Study information',
  '先填写后创建': 'Fill first, then create',
  '提交创建 Study': 'Submit Study creation',
  '提交修改 Study': 'Submit Study update',
  '请先填写必填 Study 信息': 'Fill the required Study information first',
  '提交新建': 'Submit create',
  '保存调整': 'Save changes',
  '请输入姓名': 'Enter name',
  '角色': 'Role',
  ...
  '密码修改表单': 'Password change form',
  '保存密码': 'Save password',
  '至少 8 位，并包含字母和数字': 'At least 8 characters, including letters and numbers',
  '新密码至少 8 位，且包含字母和数字。': 'The new password must be at least 8 characters and include letters and numbers.',
  ...
  '隐藏姓名': 'Hide name',
  '未录入姓名': 'Name missing',
  '未录入患者姓名，无法授权查看': 'Patient name is missing, so it cannot be revealed',
  '患者编号、患者姓名和住院号为必填项': 'Patient ID, patient name, and hospital No. are required',
  '住院号': 'Hospital No.',
  '性别': 'Sex',
  '年龄': 'Age',
  '出生日期': 'Date of birth',
  '疾病类型': 'Disease type',
  '请选择疾病类型': 'Select disease type',
  '请选择疾病类型后再保存患者': 'Select a disease type before saving the patient',
  '检测类型': 'Testing type',
  '单位类型': 'Unit type',
  ...
  '确认归档账户': 'Archive account',
  '归档后账户不能登录，但历史审计记录会保留。':
    'The account will no longer be able to sign in, but historical audit records will be retained.',
  ...
  '前列腺癌 CRPC': 'Prostate cancer CRPC',
  'CSF': 'CSF',
  'WES': 'WES',
  'scRNA-seq': 'scRNA-seq',
  '类器官构建': 'Organoid construction',
  'Olink': 'Olink',
  '检测项目汇总': 'Testing project summary',
  '剩余样本统计': 'Remaining sample summary',
  '做过检测的剩余': 'Remaining after testing',
  '做过检测样本': 'Tested samples',
  '剩余样本数': 'Remaining tested samples',
  '总检测数': 'Total tests',
  '剩余量': 'Remaining amount',
  '样本数': 'Samples',
  '占总数': 'Of total',
  ...
  '免疫相关性神经系统疾病': 'Immune-related neurological disease',
  '免疫相关性神经系统疾病 RWD 研究': 'Immune-related Neurological Disease RWD Study',
  'CRPC 前列腺癌类器官研究': 'CRPC Prostate Cancer Organoid Study',
  'CRPC 前列腺癌类器官 study': 'CRPC Prostate Cancer Organoid Study',
  '测试集': 'Test set',
  ...
  'Study 知情同意管理': 'Study Consent Management',
  '为当前 Study 配置知情同意模板；单 Study Workspace 只能保存当前 Study。':
    'Configure the consent template for the current Study; a single Study Workspace can only save its own Study.',
  'Study 配置 / 知情同意模板': 'Study Configuration / Consent Template',
  '作为当前 Study 的 CRF 与字段配置项保存，不能影响其他 Study。':
    'Saved as a CRF and field configuration item for the current Study and cannot affect other Studies.',
  '当前 Study': 'Current Study',
  '未选择 Study': 'No Study selected',
  '疾病领域': 'Disease Area',
  '当前 CRF': 'Current CRF',
  ...
  '维护患者疾病类型、样本类型、检测类型和单位类型字典，供患者队列与样本及检测下拉框使用。':
    'Manage disease, sample, testing, and unit dictionaries for patient cohort and sample/testing dropdowns.',
  '疾病类型、样本类型、检测类型和单位类型至少各保留一项':
    'Keep at least one disease type, sample type, testing type, and unit type.',
  '更新时间': 'Updated at',
  ...
  '送样量': 'Sent amount',
  '返还量': 'Returned amount',
  '剩余量由初始量减送样量加返还量自动计算': 'Remaining amount is calculated automatically from initial amount minus sent amount plus returned amount',
  '待处理': 'Pending',
  '待检测': 'Pending testing',
  '待检': 'Pending',
  '已通过': 'Passed',
  ...
  '患者编号 / 住院号 / 样本编号': 'Patient ID / hospital No. / sample ID',
  '已做检测': 'Completed testing',
  '待指定检测': 'Pending assignment',
  '待指定testing': 'Pending assignment',
  '采集开始': 'Collection start',
  '采集结束': 'Collection end',
  '采集日期范围': 'Collection date range',
  '采集日期排序': 'Collection date sort',
  '新到旧': 'Newest first',
  '旧到新': 'Oldest first',
  ...
  '送检开始': 'Testing start',
  '送检结束': 'Testing end',
  '送检日期范围': 'Testing date range',
  '送检测时间排序': 'Testing date sort',
  ...
  '蛋白组学': 'Proteomics',
  '上传结果': 'Upload result',
  '请先选择具体检测项目': 'Select a specific test item first',
  '请先创建检测项目后上传结果': 'Create the test item before uploading results',
  '该行尚未创建检测项目；请先保存检测项目后再上传结果': 'This row has no saved test item yet; save the test item before uploading results',
  '请先在多组学检测列表中选择具体检测项目，再上传结果': 'Select a specific test item in the multi-omics list before uploading results',
  '未选择检测项目，无法上传结果文件': 'No test item selected; result file cannot be uploaded',
  '未上传文件': 'No file uploaded',
  '上传中...': 'Uploading...',
  '正在读取患者、样本和检测数据...': 'Loading patient, sample, and test data...',
  '已读取患者、样本和检测数据': 'Loaded patient, sample, and test data',
  '默认显示全部患者': 'Showing all patients by default',
  '点击患者列表中的样本查看后，将自动定位到该患者的样本和检测。':
    'Click View samples in the patient list to focus that patient in sample and testing.',
  '待入库': 'Pending storage',
  '未创建检测': 'Test not created',
  '未上传': 'Not uploaded',
  '方舟未来': 'ArkBio Future',
  '无法读取后端患者数据；请重新登录或检查后端 API': 'Unable to load backend patient data; sign in again or check the backend API',
  '后端登录已失效，请重新登录后再新增样本': 'Backend session expired; sign in again before adding a sample',
  '当前授权范围暂无患者；请先在患者队列创建患者': 'No patients in the current authorized scope; create a patient in the patient queue first',
  '待分配': 'Unassigned',
  ...
  '暂无患者上下文，无法新增样本；请先在患者队列创建患者': 'No patient context; create a patient in the patient queue before adding a sample',
  '暂无样本上下文，无法新增检测': 'No sample context; cannot add test',
  '暂无样本上下文，无法新增检测；请先新增样本': 'No sample context; add a sample before adding a test',
  '请先新增样本': 'Add a sample first',
...
const dynamicRules: DynamicRule[] = [
  ...
  {
    pattern: /^已读取 (\d+) 名患者$/,
    format: (count) => `Loaded ${count} patients`
  },
  {
  ...
  {
    pattern: /^(\d+)(块|管|条)$/,
    format: (count, unit) => `${count} ${unit === '管' ? 'tubes' : unit === '条' ? 'strips' : 'blocks'}`
  },
  {
    pattern: /^(.+): 送样 (.+) \/ 返还 (.+)$/,
    format: (sampleId, sent, returned) => `${sampleId}: sent ${translateToEnglish(sent)} / returned ${translateToEnglish(returned)}`
  },
  {
    pattern: /^(.+): 送样 (.+)$/,
    format: (sampleId, amount) => `${sampleId}: sent ${translateToEnglish(amount)}`
  },
  {
    pattern: /^患者正在写入后端\.\.\.$/,
